...
| ----------- | ---------------- | --------------------------------------------------------- |
| S-属性的SDD | ✅                | ❌                                                         |
| L-属性的SDD | ✅                | ✅，兄弟之间继承属性的值只能依赖于左边符号或自身的其他属性 |
...
##### Example2: 给定LL(1)文法，写出递归下降预测翻译程序

<img src="Ch5_Syntax-Directed_Translation.assets/image-20260629101551907.png" alt="image-20260629101551907" style="zoom:50%;" />



###### Answer

<img src="Ch5_Syntax-Directed_Translation.assets/image-20260629101628273.png" alt="image-20260629101628273" style="zoom:50%;" />
